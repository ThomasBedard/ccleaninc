...
const Services = () => {
  ...
  const [selectedServices, setSelectedServices] = useState<string[]>([]); // NEW: Selected services
  ...
  // NEW: Handle selecting and deselecting services
  ...
  const proceedToDateSelection = () => {
    ...
    // Save selected services in local storage or pass via navigation state
